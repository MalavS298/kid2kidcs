...
const TeacherContent = () => {
  ...
  const handleUpload = async (weekId: number, file: File) => {
    ...
    // Delete existing files in the week folder first
    ...
    if (error) {
      ...
      toast.success(`Week ${weekId} notebook uploaded!`);
      fetchUploads();
    }
    setUploading(null);
  };
  ...
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-2xl font-semibold mb-2">Manage Content</h1>
      <p className="text-muted-foreground mb-8">Upload Jupyter notebooks (.ipynb) for each week. Students will see the content and code cells.</p>
